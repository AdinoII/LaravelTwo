...
class ContactController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('photo')){
            $input['photo'] = '/upload/photo/'.time().str_slug($input['name'], '-').'.'.$request->photo->getClientOriginalExtension();
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('photo')){
            ...
            $input['photo'] = '/upload/photo/'.time().str_slug($input['name'], '-').'.'.$request->photo->getClientOriginalExtension();            $request->photo->move(public_path('/upload/photo/'), $input['photo']);
        }
     ...
     * @return code button edit delete
     */
